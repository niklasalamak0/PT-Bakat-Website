...
import { getPricing as api_company_get_pricing_getPricing } from "~backend/company/get_pricing";
import { getServices as api_company_get_services_getServices } from "~backend/company/get_services";
import { getTestimonials as api_company_get_testimonials_getTestimonials } from "~backend/company/get_testimonials";
...
export namespace company {
    ...
    export class ServiceClient {
         ...
         */
        public async getContactSubmissions(params: RequestType<typeof api_company_get_contact_submissions_getContactSubmissions>): Promise<ResponseType<typeof api_company_get_contact_submissions_getContactSubmissions>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/contact-submissions`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_get_contact_submissions_getContactSubmissions>
        }

        /**
         * Gets database connection information for development purposes.
         */
        public async getDatabaseInfo(): Promise<ResponseType<typeof api_company_get_db_info_getDatabaseInfo>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/db-info`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_get_db_info_getDatabaseInfo>
        }

        /**
         * Retrieves portfolio projects, optionally filtered by category.
         */
        public async getPortfolios(params: RequestType<typeof api_company_get_portfolios_getPortfolios>): Promise<ResponseType<typeof api_company_get_portfolios_getPortfolios>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/portfolios`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_get_portfolios_getPortfolios>
        }

        /**
         * Retrieves pricing packages, optionally filtered by category.
         */
        public async getPricing(params: RequestType<typeof api_company_get_pricing_getPricing>): Promise<ResponseType<typeof api_company_get_pricing_getPricing>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                category: params.category,
            })
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/pricing`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_get_pricing_getPricing>
        }

        /**
         * Retrieves all services, optionally filtered by category.
         */
        public async getServices(params: RequestType<typeof api_company_get_services_getServices>): Promise<ResponseType<typeof api_company_get_services_getServices>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                category: params.category,
            })
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_get_services_getServices>
        }

        /**
         * Retrieves all testimonials.
         */
        public async getTestimonials(): Promise<ResponseType<typeof api_company_get_testimonials_getTestimonials>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/testimonials`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_get_testimonials_getTestimonials>
        }

        /**
         * Inspects database tables and their data for development purposes.
         */
        public async inspectData(params: RequestType<typeof api_company_inspect_data_inspectData>): Promise<ResponseType<typeof api_company_inspect_data_inspectData>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                limit: params.limit === undefined ? undefined : String(params.limit),
                table: params.table,
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/inspect-data`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_inspect_data_inspectData>
        }
        ...
        public async submitContact(params: RequestType<typeof api_company_submit_contact_submitContact>): Promise<ResponseType<typeof api_company_submit_contact_submitContact>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_company_submit_contact_submitContact>
        }

        /**
         * Updates the status of a contact submission.
         */
        public async updateContactStatus(params: RequestType<typeof api_company_update_contact_status_updateContactStatus>): Promise<ResponseType<typeof api_company_update_contact_status_updateContactStatus>> {
         ...
         */
        public async uploadImage(params: RequestType<typeof api_company_upload_image_uploadImage>): Promise<ResponseType<typeof api_company_upload_image_uploadImage>> {
            // Now make the actual call to the API
